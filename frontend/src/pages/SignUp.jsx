...
export default function SignUp() {
  ...
  const handleChange = (e) => {
    setFormData({...formData, [e.target.id]:e.target.value.trim()});  //trim removes spaces
  };
  
  const handleSubmit = async (e) => {
    e.preventDefault();      // this prevents the page from being reloaded after clicking submit
